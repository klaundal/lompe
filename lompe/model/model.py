...
class Emodel(object):
    def __init__(self, grid,
        ...
        self.matrix_func_DF = {'ground_mag':self._B_df_matrix_DF,
                               'convection':self._v_matrix_DF,
                               'efield':self._E_matrix_DF,
                               'space_mag_fac':self._B_cf_matrix_DF,
                               'space_mag_full':self._B_cf_df_matrix_DF,
                               'fac':self.FAC_matrix_DF}
        ...
        # Matrices to json.loadsuate electric field on inner grid:
        self.Ee_DF, self.En_DF = self._E_matrix_DF()
        self.Ee_DF, self.En_DF = self.Ee_DF, self.En_DF
